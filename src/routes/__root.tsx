...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Green Earth Foundation is a nonprofit reforesting land, cleaning oceans, and educating communities. Donate or volunteer today." },
      { property: "og:title", content: "Green Earth Foundation" },
      { property: "og:description", content: "Reforestation, ocean cleanup, and environmental education — join the movement." },
